...
const Navbar = () => {
    ...
    return (
        <>
                        ...
                        <div className="px-4 pt-4 pb-6 space-y-3">
                            {user ? (
                                <>
                                    ...
                                    <button onClick={() => { setIsTicketModalOpen(true); setIsMenuOpen(false); }} className="w-full text-left block px-3 py-2 text-gray-600 hover:bg-gray-50 rounded-md flex items-center gap-2">
            ...
            {/* Mount the User Ticket Modal here */}
